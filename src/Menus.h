...
const m menu_table[28] PROGMEM = {
  //#region Main menu
    /*  X_0  */
    {{HOME,       HOME,       HOME,       HOME,       HOME,       HOME,       HOME},
    {throwError,throwError,throwError}},
    /*  HOME_1  */
    {{HOME,       ADJ,/*IMGS*/HOME,       TEXT,       FUNCTIONS,  /*CLK*/HOME,X},
    ...
    /*  FUNCTIONS_5  */
    {{HOME,       BLINK,      FADE,       RAIN,       BATT,       ROOM,       MORE},
    {doNothing,doNothing,doNothing}},
    /*  CLK_6  */
    {{HOME,       X,          X,          X,          X,          X,          X},
    {doNothing,doNothing,doNothing}},
  ...
  {editText,readyEditText,leaveEditText}},

  /*  TEXTCOLOR_21  */
  {{TEXTFONT,     TEXTBACK,   TEXTFONT,   HOME,       X,          X,          X},
  ...
  /*  SETTIME_23 */
  {{TEXTBACK,     TEXTRUN,    TEXTBACK,   HOME,       X,          X,          X},
  {setTextWidthAndTime,readySetWidthTime,doNothing}},
  /*  TEXTRUN_24  */
  {{SETTIME,      X,          X,          X,          X,          X,          X},
  ...
  /*  SAVETEXT_25  */
  {{X,            X,          X,          X,          X,          X,          X},
  {saveString,writeStringFile,doNothing}},
  //#endregion

  //#region FUNCTIONS
  /*BLINK_26*/ // set the queue
  {{FUNCTIONS,    HOME,       X,          X,          X,          X,          X},
  {setQueue,readySetQueue,doNothing}},
  /*BLINK2_27*/ // set the on/off time
  {{FUNCTIONS,    HOME,       X,          X,          X,          X,          X},
  {setTimes,readySetTimes,doNothing}}
